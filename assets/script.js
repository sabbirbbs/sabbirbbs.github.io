...
const blogPage = `<div id="root"><span>root</span>@devil:/var/www/html/notes# apt-get upgrade</div>
			<span>Get:1 <a href="#project-1" onclick="project('notes/1.html')">Demo project</a></span><span style="float:right;padding-right:0%;"> from projects</span></br>
			<span>Get:2 <a href="#note-1" onclick="note('notes/1.html','1')">Latest post 1</a></span><span style="float:right;padding-right:0%;"> from notes</span></br>
			<span>Get:3 <a href="#note-1" onclick="note('notes/1.html','1')">Latest post 2</a></span><span style="float:right;padding-right:0%;">  from notes</span></br>
